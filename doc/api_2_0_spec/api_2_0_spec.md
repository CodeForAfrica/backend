...
https://topics.civicsignal.africa:8082/#/user/signup

Once you have an account go here to see your key:

https://topics.civicsignal.africa:8082/#/user/profile

### Example

https://app.civicsignal.africa:8082/api/v2/media/single/1?key=KRN4T5JGJ2A
...
URL: https://app.civicsignal.africa:8082/api/v2/media/list?last_media_id=1&rows=2
...
URL: https://app.civicsignal.africa:8082/api/v2/media/submit_suggestion
...
https://app.civicsignal.africa:8082/api/v2/mediahealth/list?media_id=4438
...
URL: https://app.civicsignal.africa:8082/api/v2/feeds/single/1
...
URL: https://app.civicsignal.africa:8082/api/v2/feeds/list?media_id=1
...
URL: https://app.civicsignal.africa:8082/api/v2/stories_public/single/27456565
...
URL: https://app.civicsignal.africa:8082/api/v2/stories_public/list?last_processed_stories_id=8625915

Return a stream of all stories processed by Media Cloud, greater than the `last_processed_stories_id`.

URL: https://app.civicsignal.africa:8082/api/v2/stories_public/list?last_processed_stories_id=2523432&q=text:obama+AND+media_id:1
...
URL: https://app.civicsignal.africa:8082/api/v2/stories_public/count?q=obama&fq=media_id:1
...
URL: https://app.civicsignal.africa:8082/api/v2/stories_public/count?split=1&split_period=week&q=africa%20AND%20media_id%3A1%20AND%20publish_day%3A%5B2014-01-01T00%3A00%3A00Z%20TO%202014-03-01T00%3A00%3A00Z%5D
...
URL: https://app.civicsignal.africa:8082/api/v2/stories_public/tag_count?q=obama&fq=media_id:1&limit=3
...
URL: <https://app.civicsignal.africa:8082/api/v2/wc/list?q=obama+AND+media_id:1>
...
URL: <https://app.civicsignal.africa:8082/api/v2/wc/list?q=obama+AND+media_id:1&stats=1>
...
URL: https://app.civicsignal.africa:8082/api/v2/tags/single/8875027
...
URL: https://app.civicsignal.africa:8082/api/v2/tags/list?rows=2&tag_sets_id=5&last_tags_id=8875026
...
URL: https://app.civicsignal.africa:8082/api/v2/tag_sets/single/5
...
URL: https://app.civicsignal.africa:8082/api/v2/tag_sets/list
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/register>
...
```json
{
    ...
    "has_consented": 1,
    "activation_url": "https://dashboard.civicsignal.africa:8082/activate"
}
```
...
URL: <https://app.mcivicsignal.africa:8082/api/v2/auth/activate>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/resend_activation_link>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/send_password_reset_link>
...
{
    "email": "foo@bar.baz",
    "password_reset_url": "https://dashboard.civicsignal.africa:8082/reset_password"
}
```
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/reset_password>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/login>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/profile>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/change_password>
...
URL: <https://app.civicsignal.africa:8082/api/v2/auth/reset_api_key>
...
URL: https://app.mcivicsignal.africa:8082/api/v2/stats/list
...
URL: https://app.civicsignal.africa:8082/api/v2/util/is_syndicated_ap
...
r = requests.get('https://app.civicsignal.africa:8082/api/v2/media/list',
    params = params,
...
while True:
    ...
    r = requests.get( 'https://app.civicsignal.africa:8082/api/v2/media/list', params = params, headers = { 'Accept': 'application/json'} )
    data = r.json()
...
while True:
    ...
    r = requests.get( 'https://app.civicsignal.africa:8082/api/v2/stories_public/list/', params = params, headers = { 'Accept': 'application/json'} )
    stories = r.json()
...
```bash
curl 'https://app.civicsignal.africa:8082/api/v2/wc?q=text:trayvon&fq=tags_iud_media:8875027&fq=publish_date:%5B2012-04-01T00:00:00.000Z+TO+2013-05-01T00:00:00.000Z%5D'
```
...
```bash
curl 'https://app.civicsignal.africa:8082/api/v2/wc?q=text:trayvon+AND+tags_id_media:8875027+AND+publish_date:%5B2012-04-01T00:00:00.000Z+TO+2013-05-01T00:00:00.000Z%5D&fq=tags_id_media:8875027&fq=publish_date:%5B2012-04-01T00:00:00.000Z+TO+2013-05-01T00:00:00.000Z%5D'
```
...
```bash
curl https://app.civicsignal.africa:8082/api/v2/tag_sets/list
```
...
def find_tags_id( tag_name, tag_sets_id):
    ...
    while True:
        ...
        r = requests.get( 'https://app.civicsignal.africa:8082/api/v2/tags/list/' + tag_sets_id , params = params, headers = { 'Accept': 'application/json'} )
        tags = r.json()
...
```bash
curl 'https://app.civicsignal.africa:8082/api/v2/wc?q=tags_id_media:12345678'
```
